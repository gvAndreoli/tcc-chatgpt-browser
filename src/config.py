...
WAIT_AFTER_SEND_SEC = float(os.environ.get("WAIT_AFTER_SEND_SEC", "5"))
...
SEND_MAX_WAIT_SEC = float(os.environ.get("SEND_MAX_WAIT_SEC", "180"))  # tempo máximo esperando liberar
